    ...
    $.fn.roadblocker = function(options, onClose) {
        ...
        return this.each(function() {
            ...
            if ( session != undefined ) {
                ...
                if (!cmd && timesDisplayedThisSession >= settings.timesPerSession ) {
                    if (settings.log) {
            ...
            if ( permanent != undefined ) {
                ...
                if ( !cmd && permanent.includes(neverShow) ) {
                    if (settings.log) {
                ...
                if ( !cmd && timesDisplayedAllTime >= settings.totalTimesToShow ) {
                    if (settings.log) {
